...
fn mega_test() {
    ...
    stk.eval("(println (let ((x 10)) (println x) (set! x 5) (println x) (not (not (eq x 10)))))");
    ...
    stk.eval("(defun print2 (a) (println\n (+ 5 a 1.3)))");
    stk.eval( "(println (print2 123))");
    assert!(stk.error.is_none());
